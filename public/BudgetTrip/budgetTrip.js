class UI{
    constructor(){
        this.AlertBudgetForm = document.querySelector(".alert-section-budget");
        this.AlertDepenseForm = document.querySelector(".alert-section-depense");
...
// Envoie des depense
    ...
    ajouterDepense(depense){
        ...
        div.innerHTML = `<div class="container-depense-liste"></div>
